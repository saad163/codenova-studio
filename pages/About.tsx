    ...
    <div className="bg-brand-dark min-h-screen text-brand-light">
      ...
      <section className="relative h-[55vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 pt-12">
          <h2 className="text-brand-cyan text-sm font-bold tracking-[0.4em] uppercase mb-4">Engineering Talent</h2>
          <h1 className="text-4xl md:text-7xl font-display font-black text-brand-light mb-6 uppercase tracking-tight">About CodeNova</h1>
          <div className="w-24 h-1 bg-gradient-to-r from-brand-cyan to-brand-accent mx-auto rounded-full"></div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 relative flex justify-center">
              ...
              <div className="w-full max-w-lg bg-[#080424]/80 backdrop-blur-md p-8 rounded-3xl border border-brand-primary/20 shadow-2xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="glass-card p-10 rounded-3xl relative overflow-hidden group">
              <div className="w-12 h-12 bg-brand-primary/15 rounded-xl flex items-center justify-center mb-6">
                <i className="fa-solid fa-microchip text-2xl text-brand-cyan"></i>
              </div>
            ...
            <div className="glass-card p-10 rounded-3xl relative overflow-hidden group">
              <div className="w-12 h-12 bg-brand-primary/15 rounded-xl flex items-center justify-center mb-6">
                <i className="fa-solid fa-fingerprint text-2xl text-brand-cyan"></i>
              </div>
